...
async def criar_profissional(
    ...
    try:
        ...
        transaction = contract.functions.novoProfissional(
            ...
            'nonce': w3.eth.get_transaction_count("0x5C8378C0Bc231553149266EED53C013170d0D9de")
        })
        signed_txn=w3.eth.account.sign_transaction(transaction, "0x5f874c8d056f19746b456a5046724e00b909e23560b5c540812a35701a9690b0")
